...
<div id="main">
	<div id="header">
		...
		<div id="right_head">
			...
			echo $fet['email'];
			?> | <a href="logout.php"><font color="#b50c1a">Logout</font></a></h3>
		</div>
	</div>
	<div id="container">
		<div id="sidebar">
...
<tr>
<td colspan="3"><center>
<h2 style="color:#116763;">EWU ONLINE VOTING SYSTEM</h2>
<h5 style="color:#116763;">2017-2018</h5></center>
<br />
</td>
</tr>
<tr>
<td id="bold">Vice Chacellor:</td>
<td>
