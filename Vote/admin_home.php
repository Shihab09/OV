...
<body style="background-color:#4a3666">
<div id="bar">
<div style="width:900px; margin:auto; padding-top:10px;">
<img src="images/ewuLogo.png" /></a><br><marquee scrolldelay="1" scrollamount="3"><font color="yellow">WELCOME ADMINISTRATOR.....YOU MAY ACTIVATE/DEACTIVATE AND SEARCH/DELETE STUDENT RECORDS</font></marquee>
</div>
</div>
<div id="subbar">
</div>
...
<div id="main">
	<div id="header">
		<h1><a href="admin_home.php" style="font-size:50px;color:#ad95f9;">Admin Panel</a></h1>&nbsp
		<h3 class="right">Welcome Administrator&nbsp &nbsp||&nbsp &nbsp<a href="admin_logout.php" style="">Logout</a></h3>
	</div>
	...
	<div id="content">
		...
		<table align="center" class="tbl">
			...
			<tr>
				...
				<td colspan="7" align="right"><b style="color:#8b7cbc; font-size:18px;">Enter The Firstname :</b><input type="text" name="keyword" value="<?php echo $keyword; ?>" id="keyword" />
				     <input type="submit" name="SEARCH" value="Search" onclick="return valid();" /><input type="button" name="showall" value="Show All" onClick="window.location='admin_home.php'" /></td>
			</tr>
			<tr>
				<th>&nbsp;</th>
				<th>Firstname</th>
			...
			?>
			<tr>
				<td colspan="9"><input type="submit" name="DELETE" value="Delete" /> <a href="#" onclick="javascript:checkAll();">Check All</a>&nbsp &nbsp<a href="#" onclick="javascript:unCheckAll();">Uncheck All</a></td>
			</tr>
		</table>
		</form>
	</div>
	<div id="footer">
		<font color="black"><p >Project By : SHIHAB $ PREOM</font>
		</p>
	</div>
</div>
</body>
