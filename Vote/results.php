...
<body style="background-color:#181d26">
<div id="bar">

<div style="width:900px; margin:auto; padding-top:8px;">
<img src="images/ewuLogo.png" /><marquee scrolldelay="1" scrollamount="3" direction="left" width="700"><font color='yellow' style='font-family:arial'><b>CANDIDATES WITH HIGHEST VOTE WON</font></marquee>
</div>
</div>
<div id="subbar">
...
<a href="results.php">Election Results</a> | <a href="addcand.php">Add Election Candidates</a> | <a href="admin-logout.php">Logout</a>
